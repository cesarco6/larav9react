...
const ShowProducts = () => {
    ...
    const [ producto, setProducto ] = useState({id: 0, descripcion: 'inicial'})
                ...
                { products.map( (product) => (                    
                    <tr key={product.id}>
                        ...
                        <td className="table__body table--btns">
                            ...
                            <button className="btn btn--delete tooltip" onClick={() => {                                   
                                    setProducto({id:product.id, desc:product.descripcion})                                                                                               
